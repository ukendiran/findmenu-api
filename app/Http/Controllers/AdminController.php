...
class AdminController extends BaseController
{
    ...
    public function restore($id)
    {
        ...
        return $this->sendResponse($data, 'Admin restored successfully');
    }
    ...
    public function trashed()
    {
        ...
        if ($data->isEmpty()) {
            return $this->sendError('No trashed admins found', [], 404);
        }

        return $this->sendResponse($data, 'Trashed admins retrieved successfully');
    }
}
